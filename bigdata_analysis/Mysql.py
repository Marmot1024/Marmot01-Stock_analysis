...
try:
    conn = pymysql.connect(host='localhost', user='root', password='123456', db='stock_analysis', charset='GBK')
    cur = conn.cursor()
    print('数据库连接成功！')
    print(' ')
except:
...
os.chdir('C:/Users/七夜/Desktop/数据技术原理-尹/项目/第一组-rock-基于spark的深圳证券分析第三次/data')  #将路径设置成你csv文件放的地方
path = os.getcwd()
